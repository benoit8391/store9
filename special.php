...
<?php do { ?>
  <div class="newcloth">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="110"><a href="product.php?sid=<?php echo $row_rsSpecial['sid']; ?>" target="tsFrame"><img src="imgshirt/<?php echo $row_rsSpecial['img']; ?>s.jpg" width="109" height="91" class="type2" title="<?php echo $row_rsSpecial['name']; ?>" alt="<?php echo $row_rsSpecial['name']; ?>" /></a></td>
