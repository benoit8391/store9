...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO cart (cartid, sid, `size`, qty, uname, email, addr, tel, ip) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<div id="cartlist">
  ...
  <div align="center"><img src="imgshirt/<?php echo $row_rsShirt['img']; ?>m.jpg" alt="<?php echo $row_rsShirt['name']; ?>" /></div>
  <br />
  ...
  <form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
    <table align="center">
      <tr valign="baseline">
        ...
        <td colspan="2"><input name="uname" type="text" required id="uname" size="10">
      ...
      <tr valign="baseline">
        ...
        <td colspan="2"><input name="email" type="email" required id="email" size="32"></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">地址：</td>
        <td colspan="2"><input name="addr" type="text" required id="addr" size="55"></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">手機：</td>
        <td colspan="2"><input name="tel" type="tel" required id="tel" size="32">
          <br />
          <br /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">&nbsp;</td>
        <td><input type="image" name="imageField" id="imageField" src="images/button_send.gif"></td>
        <td><div align="right"><img src="images/button_back.gif" alt="回到上一頁" width="98" height="28" border="0" /></a></div></td>
      </tr>
    </table>
