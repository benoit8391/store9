...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="350"><div id="detail"> <img src="imgshirt/<?php echo $row_rsProduct['img']; ?>l.jpg" width="350" height="294" class="type2" />
  ...
  <tr>
    <td><div> 　其他同款式的Ｔ恤：</div>
      <?php do { ?>
        <div class="picklist">
          <div class="box"><a href="product.php?sid=<?php echo $row_rsProduct['sid']; ?>"><img src="imgshirt/<?php echo $row_rsProduct['img']; ?>z.jpg" width="98" height="82" /></a></div>
          NT<?php echo $row_rsProduct['price']; ?></div>
        <?php } while ($row_rsProduct = mysql_fetch_assoc($rsProduct)); ?></td>
  </tr>
</table>
</body>
</html>
